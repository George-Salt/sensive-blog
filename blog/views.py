...
def index(request):
    ...
    likes_count = posts.annotate(num_likes=Count('likes'))
    most_popular_posts = likes_count.order_by('-num_likes')[:5]

    most_fresh_posts = list(posts.order_by('published_at'))[-5:]
